...
export default function BottomNav() {
  ...
  return (
    <nav
      className="fixed bottom-0 left-0 right-0 z-50 flex items-center justify-around bg-white/95 backdrop-blur-md border-t border-gray-200/80 px-2 safe-area-bottom"
        ...
        return (
          <button
            ...
            className={`
              ...
              transition-colors duration-200 rounded-lg min-w-[52px]
              ${isActive
                ? 'text-brand'
